...
<h1 class="title">Luxirious Suites</h1>
 ...
 <!-- RoomDetails -->
            <div id="RoomDetails" class="carousel slide" data-ride="carousel">
                ...
                <div class="item active"><img src="https://picsum.photos/seed/65/500/300" class="img-responsive" alt="slide"></div>
                <div class="item  height-full"><img src="https://picsum.photos/seed/64/500/300"  class="img-responsive" alt="slide"></div>
                <div class="item  height-full"><img src="https://picsum.photos/seed/95/500/300"  class="img-responsive" alt="slide"></div>
                </div>
                <!-- Controls -->
